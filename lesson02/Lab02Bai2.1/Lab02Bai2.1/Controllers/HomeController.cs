...
namespace Lab02Bai2._1.Controllers
{
    public class HomeController : Controller
    {
        ...
        //Action trả về một View là một trang html và nó có thể truyền tham số hoăc model
        ...
        public JsonResult TestJsonResult()
        {
            ...
            listStudent.Add(new Student() { ID = 001, Name = "Nguyễn QuangHuy", ClassName = "C1311J" });
        ...
        {
            string js = "funtion checkEMail(){var btloc=/^([w-]+(?:.[w-]+)*)@((?: [w -] +.) * w[w -]{ 0,66}).([a - z]{ 2,6} (?:.[a - z]{ 2})?)$/ i" +
                "if (btloc.test(mail)) { kq = true; }else{     alert(“Email address invalid”); " +
                "kq = false;}return kq;}";
